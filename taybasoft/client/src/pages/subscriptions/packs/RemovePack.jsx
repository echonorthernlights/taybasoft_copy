...
import { useDeletePackMutation, useGetPacksQuery } from "../../../slices/subscriptions/packsApiSlice"
  ...
  return (
    <Wrapper>
      <Form onSubmit={handleSubmit} className="form">
        ...
        <p className="remove-confirmation">Etes vous sur de vouloir supprimer le pack avec ID : {packId} ?</p>
        <div className="buttons-container">
          <SubmitBtn formBtn isLoading={loadingPack} deleteBtn />
          <Link className="btn btn-secondary" to="/app/packs">
            retour
          </Link>
        </div>
      </Form>
