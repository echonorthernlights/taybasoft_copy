        ...
        subscriptions.map((sub) => {
          if (sub.status === "pending") {
            return {
              ...sub,
              operations: {
                updatePath: `/app/subscribers/${subscriberId}/subscriptions/${sub.id}/edit`,
                deletePath: `/app/subscribers/${subscriberId}/subscriptions/${sub.id}/delete`,
              },
            }
          }
          return {
          ...
          <ObjectWrapper>
            ...
            <div className="details-content">
              ...
              <div className="operations">
                <Link
                  className="btn"
                  to={`/app/subscribers/${subscriber.id}/edit`}
                >
                  modifier
                </Link>
                {subscriptions && !subscriptions.find((sub) => (sub.status != "pending")) &&
                  (<Link
                    className="btn danger-btn"
                    to={`/app/subscribers/${subscriberId}/delete`}
                  >
                    supprimer
                  </Link>)
                }
